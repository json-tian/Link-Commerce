...
export function postApiData(url, body) {
  return axios
    .post(API_BASE + backendApi + url, body)
    .then((response) => response.data);
}

export function getApiData(url) {
  return axios
    .get(API_BASE + backendApi + url)
    .then((response) => response.data);
}

export function patchApiData(url, body) {
  return axios
    .patch(API_BASE + backendApi + url, body)
    .then((response) => response.data);
}

export function deleteApiData(url) {
  return axios
    .delete(API_BASE + backendApi + url)
    .then((response) => response.data);
}
